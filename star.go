...
var mixbright = uint8(bright*165/255)
var tween = uint8(228)
var med = uint8(196)
var mixmed = uint8(med*165/255)
var dim = uint8(128)
var mixdim = uint8(dim*165/255)
var submix = uint8(99)
...
func getStarDetails(classDetails classdetails, sector sector, random *rand.Rand) []star {
	stars := make([]star, 0)
	var loopsize = int32(1000 * (classDetails.odds - classDetails.fudge + 2*classDetails.fudge*random.Float32()))
